...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-bg-soft relative overflow-hidden">
      ...
      <div className="absolute left-[633px] top-[81px] w-[279px] h-[279px] rounded-full opacity-40 pointer-events-none"
        style={{
          background: "linear-gradient(180deg, rgba(49, 133, 252, 0.20) 0%, rgba(179, 216, 255, 0.20) 100%)"
        }}
      />
      <div className="absolute right-[24px] top-[657px] w-[150px] h-[150px] rounded-full bg-[#B3D8FF] opacity-40 pointer-events-none" />
      <div className="absolute right-0 bottom-[133px] w-[200px] h-[200px] rounded-full opacity-40 pointer-events-none"
        style={{
          background: "linear-gradient(315deg, #B3D8FF 0.3%, #3185FC 99.7%)"
        }}
      />
      ...
      <section className="relative z-10 max-w-[1200px] mx-auto px-6 pt-12 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative rounded-[20px] overflow-hidden shadow-[0_10px_40px_0_rgba(49,133,252,0.20)]"
              style={{
                background: "linear-gradient(318deg, #B3D8FF 0.42%, #3185FC 97.26%)"
              }}
            >
      ...
      <section className="relative z-10 max-w-[1200px] mx-auto px-6 py-20">
        <h2 className="text-primary-blue text-center text-3xl font-bold mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, index) => (
            <div
              key={index}
              className="p-8 border-2 border-[#B3D8FF] bg-bg-soft rounded-xl hover:shadow-lg transition-shadow"
            >
              ...
              <h3 className="text-primary-blue text-2xl font-bold mb-4 text-center">
                {feature.title}
              </h3>
      ...
      <section className="w-full bg-primary-blue py-16 relative z-10">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white text-base mb-8">
            Join thousands of other students who have found their perfect fit with Future Student
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button className="px-4 py-2 text-sm font-bold text-primary-blue border-2 border-primary-blue bg-white rounded-lg hover:bg-gray-50 transition-colors">
              Create Your Free Account
            </button>
            <button className="px-4 py-2 text-sm font-medium text-white border-2 border-white bg-primary-blue rounded-lg hover:bg-blue-600 transition-colors">
              Sign In
            </button>
          </div>
        </div>
